...
export default function EmployeeProfilePage() {
  ...
  useEffect(() => {
    if (employee) {
      setEmpFName(employee.Emp_FName || '');
      setEmpLName(employee.Emp_LName || '');
      setEmpPhone(employee.Emp_PhoneNo || employee.phoneNo || '');
    }
  }, [employee]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateOwnStaffProfile(employee!.uid, {
        firstName: empFName,
        lastName: empLName,
        phoneNo: empPhone,
      ...
      const refreshedSession = await fetchStaffSession(employee!.uid);
      setEmployee(refreshedSession ?? {
        ...employee!,
        ...data,
  ...
  const displayName = `${employee.Emp_FName} ${employee.Emp_LName}`;
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="bg-red-600 px-6 py-8 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">{employee.Emp_Position}</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-xl px-4 py-3">
                ...
                <div className="text-sm text-gray-600 truncate">{employee.Emp_Email}</div>
              ...
              <div className="bg-gray-50 rounded-xl px-4 py-3">
                ...
                <div className="text-sm text-gray-600">Branch {employee.Emp_BranchID}</div>
                <div className="text-xs text-gray-400 mt-0.5">Contact admin to change</div>
              </div>
            </div>
